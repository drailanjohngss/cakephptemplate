...
return [
     ...
     */
    'Security' => [
        'salt' => 'b42934e79ec1686661f75b1985a69d22ce2e914f3ad7799e35b034ccbc77e98e',
    ],
    ...
    'Session' => [
        'defaults' => 'database',
        'cookie' => 'SID',      // セッション・クッキー名
        'timeout' => 60,      // セッションDB有効期限=1時間 (分単位)
        'ini' => [
            'session.cookie_lifetime' => 60 * 60,     // セッション・クッキー有効期限=1時間 (秒単位)
        ]
    ],
];
